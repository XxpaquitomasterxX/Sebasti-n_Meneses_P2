...
cout <<result_2 <<"\n";//se enseña otro resultado
cout<<"Esta sería la multiplicación de ambos resultados:" ; cout<<result_1*result_2;//se realiza una multiplicación y se enseña
